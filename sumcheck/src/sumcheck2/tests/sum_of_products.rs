...
fn product_sumcheck_test<F: PrimeField>() {
    ...
    // We define the params of the instance of our relation, SumcheckRelation in
    // this case, and SumcheckInstance.
    // SumcheckInstance has no params, for that reason is ().
    let params = ();
